...
//! ```rust
//! use std::io::Cursor;
//! use lintdiff_ingest_core::{parse_cargo_messages, DiagnosticLevel};
//!
...
///
/// ```rust
/// use lintdiff_ingest_core::{Diagnostic, DiagnosticLevel, Span};
/// use lintdiff_types::NormPath;
///
...
///
/// ```rust
/// use lintdiff_ingest_core::{parse_cargo_messages, DiagnosticsParseError};
/// use std::io::Cursor;
///
